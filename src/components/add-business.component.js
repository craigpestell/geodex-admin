...
export default class AddBusiness extends Component {
  constructor(props) {
    ...
    this.newBusiness = this.newBusiness.bind(this);
      ...
      <div className="submit-form">
        {this.state.submitted ? (
          <div>
            ...
            <button className="btn btn-success" onClick={this.newBusiness}>
              Add
            </button>
          </div>
        ) : (
          <div>
            ...
            <button onClick={this.saveBusiness} className="btn btn-success">
              Submit
            </button>
          </div>
        )}
